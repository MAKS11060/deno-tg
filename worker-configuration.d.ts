/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fcd6c79770b52a738053efc14cf1b964)
// Runtime types generated with workerd@1.20260617.1 2026-05-17 
interface __BaseEnv_Env {
	BOT_TOKEN: string;
	BOT_INFO: string;
	WEBHOOK_SECRET: string;
	WEBHOOK_URI: string;
	WEBHOOK_URI_LOCAL: string;
	DANBOORU_LOGIN: string;
	DANBOORU_APIKEY: string;
	DANBOORU_USER_AGENT: string;
	KEY: string;
	CERT: string;
	WRANGLER_HTTPS_KEY_PATH: string;
	WRANGLER_HTTPS_CERT_PATH: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./main-workerd");
	}
